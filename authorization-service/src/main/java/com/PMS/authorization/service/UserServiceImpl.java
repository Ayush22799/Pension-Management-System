...
import com.PMS.authorization.repository.UserRepository;
...
public class UserServiceImpl implements UserDetailsService {
	...
	public Optional<User> findByUsername(String username) {
	 ...
	 //Loads user from the database if it exists. After loading the details, compares the given username from username in the DB.
