...
import com.PMS.authorization.exception.InvalidCredentialsException;
...
import lombok.extern.slf4j.Slf4j;
 ...
 // Authorization Controller to handle requests for logging in a valid user and validating the JWT Token for other services.
...
public class AuthorizationController {
	...
	public String statusCheck() {
		log.info("OK");
		return "Authorization service run succesfully";
	}
}
