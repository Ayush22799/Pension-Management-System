...
import com.PMS.authorization.exception.InvalidTokenException;
...
import com.PMS.authorization.model.UserRequest;
import com.PMS.authorization.service.UserServiceImpl;
...
class AuthorizationControllerTests {
	...
	void testValidateAdmin_withValidTokenAndRole() throws Exception {
		...
		when(userServiceImpl.loadUserByUsername(ArgumentMatchers.any())).thenReturn(new User("admin1", "$2a$10$aMMcsBB18R7dqzC7Wcg3z.oiVQnNhgFGD0WMTZVeVtFCMMnru25AO",
	...
	void testStatusCheck() throws Exception {
		...
		assertEquals("Authorization service run succesfully", contentAsString);
